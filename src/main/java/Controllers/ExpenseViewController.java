...
import com.example.personalfinancemanager.Expense;
...
public class ExpenseViewController {
    ...
    private void initializeCategories() {
        categoryChoiceBox.getItems().addAll("Food", "Road", "Phone", "Groceries", "Other");
    ...
    private void handleOkButtonAction() {
        ...
        try {
            ...
            SingletoneFinanceDataManager.getInstance().addExpense(expense);
